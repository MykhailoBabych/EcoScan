  ...
  return (
    <View style={styles.scanItem}>
      ...
      <View style={styles.scanInfo}>
        <Text
          style={[styles.scanLabel, { color: theme.text }]}
          numberOfLines={1}
        >
          {item.objectLabel}
        </Text>
...
export default function ProfileScreen() {
  ...
  const activeCats = (
    Object.entries(categoryStats) as [WasteCategory, number][]
  )
  ...
  const nextLevelPoints =
    level.maxPoints === Infinity ? null : level.maxPoints + 1;
          ...
          <View style={styles.progressWrapper}>
            ...
            <View style={styles.progressLabels}>
              ...
              {nextLevelPoints ? (
                ...
                <Text style={[styles.progressText, { color: levelColor }]}>
                  MAX
                </Text>
              )}
            </View>
